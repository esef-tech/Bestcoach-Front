        ...
        <Container>
          <Row className="pt-5">
            ...
            <Col lg={3} md={6} className="mb-5">
              ...
              <nav className="social-links-footer" aria-label="Social Media Links">
                <a 
                  ...
                  className="social-btn-footer-social" 
                  target="_blank" 
            ...
            <Col lg={3} md={6} className="mb-5">
              ...
              <nav className="quick-links-footer" aria-label="Quick Navigation Links">
                <RouterLink to="/" className="footer-link-footer mb-2">
                  <FaAngleRight className="me-2" aria-hidden="true" />Home
                </RouterLink>
                <RouterLink to="/about" className="footer-link-footer mb-2">
                  <FaAngleRight className="me-2" aria-hidden="true" />About Us
                </RouterLink>
                <RouterLink to="/services" className="footer-link-footer mb-2">
                  <FaAngleRight className="me-2" aria-hidden="true" />Our Services
                </RouterLink>
                <RouterLink to="/contact" className="footer-link-footer mb-2">
                  <FaAngleRight className="me-2" aria-hidden="true" />Contact Us
                </RouterLink>
                <RouterLink to="/faq" className="footer-link-footer mb-2">
                  <FaAngleRight className="me-2" aria-hidden="true" />FAQ's
                </RouterLink>
                <RouterLink to="/help" className="footer-link-footer mb-2">
                  <FaAngleRight className="me-2" aria-hidden="true" />Help
                </RouterLink>
                <RouterLink to="/terms" className="footer-link-footer mb-2">
                  <FaAngleRight className="me-2" aria-hidden="true" />Terms of Use
                </RouterLink>
                <RouterLink to="/privacy" className="footer-link-footer">
                  <FaAngleRight className="me-2" aria-hidden="true" />Privacy Policy
                </RouterLink>
              </nav>
            </Col>
            ...
            <Col lg={3} md={6} className="mb-5">
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Button 
                  type="submit" 
                  id="btn-news" 
                  className="newsletter-footer btn-block w-100 text-white" 
                  disabled={status.loading}
                  style={{ backgroundColor: '#00394f' }}
                >
                  {status.loading ? (
                    <>
          ...
          <div className="footer-bottom">
            <p className="m-0 text-center">
              ...
              <a 
                href="https://bestcoachmusic.netlify.app/" 
                target="_blank" 
                rel="noopener noreferrer"
                aria-label="Visit Bestcoach Music official website"
                className='text-color-footer font-weight-bold'
              >
                Bestcoach
              </a>{' '}
              •{' '}
              <a 
                href="https://esef-tech.netlify.app/" 
                target="_blank" 
                rel="noopener noreferrer"
                aria-label="Visit Bestcoach Developer website"
                className='text-color-footer font-weight-bold'
              >
                Bestcoach.Dev
              </a>
