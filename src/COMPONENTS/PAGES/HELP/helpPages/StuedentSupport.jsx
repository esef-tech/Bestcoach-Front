  ...
  return (
    <React.Fragment >
       <section className="teacher-support-page">
            {/* Header */}
            <div className="header-student text-white text-center py-4 animate-fade-in">
            ...
            <Container fluid className="bg-light py-3">
              <Row className="justify-content-center">
                <Col md={10} className="d-flex justify-content-between">
                  ...
                  <a href="/help/student-support" className="nav-link">Student Support</a>
...
export default StuedentSupport
