      ...
      content: (
        <Container className="py-5">
          <Row className="align-items-center section-equal">
            ...
            <Col md={6} className="animate-fade-in">
              <h2 className="mb-4 text-primary">What else does the  Bestcoach Music  Loyalty  Project offer?</h2>
              ...
              <div className="text-center text-md-start">
                <Button variant="light" size="lg" href="mailto:bestcoachmusic@gmail.com?subject=Ambassador Program Inquiry&body=I'd like to schedule a call about the Ambassador Program." className="animate-bounce-in">Enroll Now</Button>
              </div>
            </Col>
          </Row>
        </Container>
