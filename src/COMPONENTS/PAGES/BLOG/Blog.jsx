      ...
      <Container className="py-5">
        <Row>
          <Col lg={8}>
            ...
            {/* Pagination (dynamic - stub for now) */}
          ...
          <Col lg={4} className="mt-5 mt-lg-0 animate-slide-right">
            ...
            <div className="mb-5">
              ...
              <ul className="list-group">
                <li className="list-group-item"><a href="#">Music Education</a></li>
                <li className="list-group-item"><a href="#">Instrument Tips</a></li>
                <li className="list-group-item"><a href="#">Teaching Strategies</a></li>
                <li className="list-group-item"><a href="#">Student Stories</a></li>
              </ul>
            </div>
